...
>
{/* 标题部分 */}
<h2 data-layername="智富匯基金" className="text-6xl max-lg:text-5xl max-md:text-4xl max-sm:text-3xl font-medium text-white pt-16 max-lg:pt-14 max-md:pt-12 max-sm:pt-10 text-center" >
智富匯基金
</h2>
